...
func TestApp_CheckOdooStatus(t *testing.T) {
	...
	testutil.ExpectedEqual(t, status.LanStatus, "disconnected")
}
...
func TestApp_AppVariableAndPrintersAndGetPrinterIp(t *testing.T) {
	...
	testutil.ExpectedEqual(t, app.GetPrinterIp("czpTTjEyMzQ1Ng"), fmt.Sprintf("%s/p/czpTTjEyMzQ1Ng", srv.LocalAddr()))
