import image1 from "../images/zadig1.jpg";
import image2 from "../images/zadig2.jpg";
import image3 from "../images/zadig3.jpg";

export function zadigSteps(printerName: string) {
  return [
    {
...
export function brewSteps(printerName: string) {
  return [
    {
...
export function linuxSteps(printerName: string) {
  return [
    {
      title: "Install libusb",
    ...
    },
    {
      ...
      desc: "Open a terminal and run the command to grant USB access:",
      codes: [
